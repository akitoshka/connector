...
public class MyConnectDistributed {
    private static final Logger log = LoggerFactory.getLogger(MyConnectDistributed.class);

    public static void main(String[] args) throws Exception {
        if (args.length < 1) {
            log.info("Usage: MyConnectDistributed worker.properties");
            Exit.exit(1);
        }
        ...
        ProxyRestServer rest = new ProxyRestServer(config);
